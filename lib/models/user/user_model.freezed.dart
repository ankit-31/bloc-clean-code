...
@JsonKey(name: 'token') String get token;//it is jsonkey coming from response of login api
@JsonKey(name: 'error') String get error;
...
//it is jsonkey coming from response of login api
